...
public class StringByteLengthLimitTest {
    ...
    public void validate_toShort() {
        assertThat(StringByteLengthLimit.of(2, 4).validate("1").isPresent(), is(true));
    }

    @Test
    public void validate_toLong() {
        assertThat(StringByteLengthLimit.zeroTo((1+2+2) - 1).validate("aåä").isPresent(), is(true));
    }

    @Test
    public void validate_utf16_toLong() {
        assertThat(StringByteLengthLimit.of(0, (4+2+2) - 1, StandardCharsets.UTF_16).validate("abc").isPresent(), is(true));
    }
